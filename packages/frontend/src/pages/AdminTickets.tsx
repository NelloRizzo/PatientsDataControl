      ...
      <div className="flex gap-2 flex-wrap">
        ...
        {['', 'suggestion', 'bug_report'].map((t) => (
          <button key={t} onClick={() => setF('type', t)}
            ...
            {t ? (t === 'suggestion' ? 'Suggerimenti' : 'Bug') : 'Tutti i tipi'}
          </button>
        ))}
      </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-xs text-gray-400">da {(t as any).userId?.name || '?'}</span>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-lg mx-4 max-h-[80vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p>{(selected as any).userId?.name || '?'} ({(selected as any).userId?.email || ''})</p>
              </div>
